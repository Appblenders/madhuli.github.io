...
/* ==========================================================================
   ...
   ========================================================================== */
    ...
    var countUpNumber1 = document.getElementById('countup-number-1');
    var countUp = setInterval(function() {
        var currentValue = parseInt(countUpNumber1.innerHTML);
        if (currentValue < 1000) {
            countUpNumber1.innerHTML = currentValue + 1 + "+";
        } else {
            clearInterval(countUp);
        }
    }, 1);

    var countUpNumber2 = document.getElementById('countup-number-2');
    var countUp = setInterval(function() {
        var currentValue = parseInt(countUpNumber2.innerHTML);
        if (currentValue < 500) {
            countUpNumber2.innerHTML = currentValue + 1 + "+";
        } else {
            clearInterval(countUp);
        }
    }, 1);

    var countUpNumber3 = document.getElementById('countup-number-3');
    var countUp = setInterval(function() {
        var currentValue = parseInt(countUpNumber3.innerHTML);
        if (currentValue < 50) {
            countUpNumber3.innerHTML = currentValue + 1 + "+";
        } else {
            clearInterval(countUp);
        }
    }, 1);